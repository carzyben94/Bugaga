...
# ============================================================
# СОЗДАЁМ КОНФИГ ДЛЯ PRIME AGENT (новое!)
# ============================================================
RUN mkdir -p /root/.prime/agent && \
    echo '{"providers":{"litellm":{"baseUrl":"http://localhost:4000/v1","api":"openai-completions","apiKey":"'$AGNES_API_KEY'","models":[{"id":"agnes-2.0-flash"}]}}}' > /root/.prime/agent/models.json
