...
2. ВИДИМЫЕ структурные элементы
...
class Memory:
    ...
    def get_element_names(self):
        """Возвращает список названий элементов на странице"""
...
class BrowserCDP:
    ...
    # ========== СБОР ВСЕХ ИНТЕРАКТИВНЫХ ЭЛЕМЕНТОВ (УЛУЧШЕННЫЙ) ==========
            ...
            js = """
                (function() {
                    ...
                    function getSelector(el) {
                        ...
                        // 2. По data-testid (самый надежный для X.com)
                        ...
                        // 4. По aria-labelledby
                        if (el.getAttribute('aria-labelledby')) {
                            return '[aria-labelledby="' + el.getAttribute('aria-labelledby') + '"]';
                        }
                        
                        // 5. По aria-describedby
                        if (el.getAttribute('aria-describedby')) {
                            return '[aria-describedby="' + el.getAttribute('aria-describedby') + '"]';
                        }
                    ...
                    const interactiveSelectors = [
                        ...
                        '[data-testid="compose-tweet-button"]',
                        '[aria-label*="Home"]',
                        '[aria-label*="Explore"]',
        ...
        try:
            ...
            if interactive:
                ...
                for el in interactive[:30]:
                    ...
                    selector = el.get('selector', '')
                    if text_el:
                        interactive_text.append(f"• {visible} [{el_type}] {text_el} ({selector})")
...
def main():
    print("="*50)
    print("🚀 ЗАПУСК БОТА (ВСЕ ИНТЕРАКТИВНЫЕ ЭЛЕМЕНТЫ)")
    print("="*50)
    print(f"📌 Chrome путь: {CHROME_PATH}")
    print("🕵️ Маскировка: ВКЛЮЧЕНА")
    print("🍪 Куки: ВКЛЮЧЕНЫ (X.com)")
    print("🌐 AI перевод: ВКЛЮЧЕН")
    print("🔍 Поиск по data-testid: ВКЛЮЧЕН")
    print("🔍 Поиск по aria-label: ВКЛЮЧЕН")
    print("🔍 Поиск по ролям: ВКЛЮЧЕН")
    print("📊 Сбор всех интерактивных элементов: ВКЛЮЧЕН")
    print("="*50)
    ...
    print("🔍 Находит все интерактивные элементы по data-testid, aria-label, role!")
    app.run_polling()
