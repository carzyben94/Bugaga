...
# ============================================================
# 5. СИСТЕМНЫЙ ПРОМПТ С УНИВЕРСАЛЬНЫМ ФОРМАТИРОВАНИЕМ
# ============================================================
...
Для цен:
{
  ...
  "price": "1199€",
  "memory": "256GB",
  "url": "https://apple.com/de/iphone-15-pro",
  "note": "Цена актуальна на текущую дату"
}

Для информации о странице:
{
  "source": "🌐 Example Site",
...
9. Данные должны быть читаемыми для человека
10. Добавляй try/except с выводом ошибок
11. Используй time.sleep() для ожидания загрузки
