# cookies.py - ТОЛЬКО ДЛЯ QWEN (без дубликатов)

COOKIES = [
    # === chat.qwen.ai cookies (только эти нужны для бота) ===
    {
        "domain": ".chat.qwen.ai",
        "name": "acw_tc",
...
if __name__ == "__main__":
    ...
    name_counts = Counter([c["name"] for c in qwen_cookies])
